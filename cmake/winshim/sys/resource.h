 ...
 * the include path solely inside `if(WIN32)`). MinGW's libstdc++/POSIX builds include this
 * header for getrusage()/ru_maxrss; Windows has no getrusage, so this stub reports 0
