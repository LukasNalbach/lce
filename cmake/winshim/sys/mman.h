 ...
 * allocator API used by some of the bundled libraries onto calloc/realloc/free. This
 * drops the transparent-hugepage optimization but is functionally correct.
 */
#pragma once
